...
const { newAcknowledgement, getAcknowledgement, getSingleAcknowledgement, updateAcknowledgement } = require('../../../controllers/admin/vendor-management/acknowledgementController');
